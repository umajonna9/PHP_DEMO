pipeline{
    ...
    sh "ssh -o StrictHostKeyChecking=no ${DEV_SERVER_IP} 'bash /home/ec2-ser/docker-files/docker-script.sh'"
    ...
    sh "ssh -o StrictHostKeyChecking=no ${DEPLOY_SERVER_IP} 'bash /home/ec2-ser/docker-files/docker-script.sh'"
    sh "ssh ${DEPLOY_SERVER_IP} sudo docker login -u $USERNAME -p $PASSWORD"
    sh "ssh ${DEPLOY_SERVER_IP} 'bash /home/ec2-ser/docker-files/docker-compose-script.sh ${IMAGE_NAME}'"
                }
                }
            }
        }
